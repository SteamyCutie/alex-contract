...
contract alex is ERC721Enumerable, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    constructor() ERC721("Alex NFT", "AL") {
        setBaseURI("");
    }
    ...
    modifier firstMinter(uint256 tokenId_) {
        require(
            ...
            "Unfortunately you aren't among our genesis minters"
        );
        _;
    }
    ...
    function liquiditywithdraw(uint256 tokenId_)
        public
        firstMinter(tokenId_)
        nonReentrant
    {
